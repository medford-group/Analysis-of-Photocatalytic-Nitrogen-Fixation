...
\includegraphics[width=8.47cm,height=4.76cm,]{figures/TOC.pdf}
\caption{Energetics of photocatalytic nitrogen fixation over rutile (110) titania active sites. Photocatalysis provides a route to nitrogen fixation at atmospheric conditions and sustainable fertilizer production.}
\label{fig:TOC}
\end{figure}
