...
\caption{Free energy pathways over pristine (blue), iron-doped (red) and oxygen-vacancy defect (black) for the associative nitrogen reduction reaction the equilibrium potential.}
\label{fig:TOC}
\end{figure}
